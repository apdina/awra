...
export function Navigation({ isAuthenticated, user, session, loading = false, onLogout, onNavigateHome }: NavigationProps) {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 glass-card border-b border-gray-700/50 z-50 backdrop-blur-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            {loading ? (
              /* Show loading placeholder when authentication state is loading */
          ...
          <div className="md:hidden flex items-center space-x-2">
            ...
            {/* Mobile User Icon - Show when authenticated */}
