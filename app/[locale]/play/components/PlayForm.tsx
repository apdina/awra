/**
 * Mobile Play Form Component
 * 
 * Old mobile design with table-like layout
 * 8 input rows with dark theme and gradient styling
 */
...
export function PlayForm({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex flex-col">
      {/* Error Display */}
      {error && (
        <div className="bg-red-900/30 border-2 border-red-500/50 rounded-lg p-3 m-4">
